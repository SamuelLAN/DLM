...
class Train(TrainBase):
    ...
    def __init__(self):
        # load the data
        self.train_loader = Loader(*self.train_preprocess_dirs)
        self.val_loader = Loader(*self.val_preprocess_dirs)

        # get the generator of the dataset
        self.train_data = self.train_loader.generator(Model.pos_emb, Model.train_params['batch_size'])
        self.val_data = self.val_loader.generator(Model.pos_emb, Model.train_params['batch_size'])
        ...
        self.train_example_x, self.train_example_y = self.train_loader.batch_example(Model.pos_emb)
        self.train_batch = self.train_loader.batch_data(Model.pos_emb)
        self.val_batch = self.val_loader.batch_data(Model.pos_emb)
        ...
        self.train_stats = self.train_loader.show_statistics(Model.pos_emb)
        self.val_stats = self.val_loader.show_statistics(Model.pos_emb)
