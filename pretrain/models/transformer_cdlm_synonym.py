...
from pretrain.preprocess.inputs import CDLM_synonym
...
class Model(BaseModel):
    ...
    data_params = {
        **BaseModel.data_params,
        ...
        'input_incr': Ids.end_cdlm_synonym_2 + 1,  # <start>, <end>, <pad>, <mask>
        'class_incr': Ids.end_cdlm_synonym_2 + 1,  # <start>, <end>, <pad>, <mask>
    }
    ...
    encode_pl = preprocess_pl + sent_2_tokens + CDLM_synonym.combine_pl(**pretrain_params) + CDLM_encode
    decode_pl = d_pl('')
