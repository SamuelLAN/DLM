...
class Model(BaseModel):
    name = 'transformer_nmt_baseline_en_zh'

    preprocess_pipeline = zh_en.seg_zh_by_jieba_pipeline_for_tar + noise_pl.remove_noise + tfds_share_pl.train_tokenizer + tfds_share_pl.encode_pipeline
    # for test
    tokenizer_pl = zh_en.seg_zh_by_jieba_pipeline_for_tar + noise_pl.remove_noise + tfds_share_pl.train_tokenizer
    encode_pipeline = zh_en.seg_zh_by_jieba_pipeline_for_tar + noise_pl.remove_noise + tfds_share_pl.encode_pipeline
    encode_pipeline_for_src = noise_pl.remove_noise_for_src + tfds_share_pl.encode_pipeline_for_src
    encode_pipeline_for_tar = zh_en.seg_zh_by_jieba_pipeline + noise_pl.remove_noise_for_src + tfds_share_pl.encode_pipeline_for_src
    decode_pipeline_for_src = tfds_share_pl.decode_pipeline
    decode_pipeline_for_tar = tfds_share_pl.decode_pipeline + zh_en.remove_space_pipeline
