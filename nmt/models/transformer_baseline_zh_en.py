...
class Model(BaseModel):
    name = 'transformer_nmt_baseline_zh_en'

    preprocess_pipeline = zh_en.seg_zh_by_jieba_pipeline + noise_pl.remove_noise + tfds_share_pl.train_tokenizer + tfds_share_pl.encode_pipeline
    # for test
    ...
    encode_pipeline_for_src = zh_en.seg_zh_by_jieba_pipeline + noise_pl.remove_noise_for_src + tfds_share_pl.encode_pipeline_for_src
    ...
    data_params = {
        **BaseModel.data_params,
        ...
        'max_src_seq_len': 60,
        'max_tar_seq_len': 60,
        'sample_rate': 0.226,  # sample "sample_rate" percentage of data into dataset; range from 0 ~ 1
        'input_incr': 4,
    }
