...
class Model(BaseModel):
    name = 'transformer_nmt_CDLM_translate_pretrained'
    ...
    data_params = {
        **BaseModel.data_params,
        ...
        'input_incr': Ids.end_cdlm_t_2 + 1,
        'class_incr': Ids.end_cdlm_t_2 + 1,
    }
    ...
    checkpoint_params = {
        'load_model': ['transformer_CDLM_translate_wmt_news', '2020_05_13_05_02_12'],  # [name, time] # test
