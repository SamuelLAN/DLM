...
class Model(BaseModel):
    name = 'transformer_nmt_CDLM_fully_share_pretrained'
    ...
    data_params = {
        **BaseModel.data_params,
        ...
        'input_incr': Ids.end_cdlm_def + Ids.pos_ids + Ids.ner_ids + 1,
        'class_incr': Ids.end_cdlm_def + Ids.pos_ids + Ids.ner_ids + 1,
    }
