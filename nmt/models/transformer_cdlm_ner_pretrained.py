...
class Model(BaseModel):
    name = 'transformer_nmt_CDLM_ner_pretrained'
    ...
    data_params = {
        **BaseModel.data_params,
        ...
        'input_incr': Ids.end_cdlm_ner_2 + Ids.ner_ids + 1,
        'class_incr': Ids.end_cdlm_ner_2 + Ids.ner_ids + 1,
    }
    ...
    checkpoint_params = {
        'load_model': ['transformer_CDLM_ner_wmt_news', '2020_05_13_15_07_07'],  # [name, time] # test
