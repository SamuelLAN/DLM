...
class Model(BaseModel):
    name = 'transformer_nmt_CDLM_pos_pretrained'
    ...
    data_params = {
        **BaseModel.data_params,
        ...
        'input_incr': Ids.end_cdlm_pos_2 + Ids.pos_ids + 1,
        'class_incr': Ids.end_cdlm_pos_2 + Ids.pos_ids + 1,
    }
    ...
    checkpoint_params = {
        'load_model': ['transformer_CDLM_pos_wmt_news', '2020_05_13_18_04_08'],  # [name, time] # test
