...
class Model(BaseModel):
    name = 'transformer_nmt_CDLM_definition_pretrained'
    ...
    data_params = {
        **BaseModel.data_params,
        ...
        'input_incr': Ids.end_cdlm_def + 1,
        'class_incr': Ids.end_cdlm_def + 1,
    }
    ...
    checkpoint_params = {
        'load_model': ['transformer_CDLM_definition_wmt_news', '2020_05_13_17_28_56'],  # [name, time] # test
